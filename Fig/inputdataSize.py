...
if __name__ == '__main__':
    ...
    for length in lengths:
        with open(f"../tb/test_cases/test_case_{length}.txt", "r") as file:
            hex_in = file.read()
    ...
    print(times_gpu_naive)
    print(times_gpu_shared)
    print(times_gpu_shared_coalesced)
    print(times_gpu_shared_coalesced_noconst)
    print(times_private)
    print(times_private_sharedlut)
    print(times_cpu)
