...
def test1_RoundTest():
    ...
    result_gpu_shared_coalesced_noconst = \
        graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 16, "shared_coalesced_noconst")[0]
...
def test2_RoundTest():
    ...
    assert np.array_equal(result_gpu_shared_coalesced, byte_array_ref)
    result_gpu_shared_coalesced_noconst = \
        graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 32, "shared_coalesced_noconst")[0]
    assert np.array_equal(result_gpu_shared_coalesced_noconst, byte_array_ref)
...
def test3_RoundTest():
    ...
    assert np.array_equal(result_gpu_shared_coalesced, byte_array_ref)
    result_gpu_shared_coalesced_noconst = \
        graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 192, "shared_coalesced_noconst")[0]
    assert np.array_equal(result_gpu_shared_coalesced_noconst, byte_array_ref)
...
def test4_RoundTest():
    ...
    assert np.array_equal(result_gpu_shared, byte_array_ref)
    result_gpu_shared_coalesced = \
        graphicscomputer.AES_gpu(byte_array_in, byte_array_key, byte_array_in.size, "shared_coalesced")[0]
    assert np.array_equal(result_gpu_shared_coalesced, byte_array_ref)
    result_gpu_shared_coalesced_noconst = \
        graphicscomputer.AES_gpu(byte_array_in, byte_array_key, byte_array_in.size, "shared_coalesced_noconst")[0]
    assert np.array_equal(result_gpu_shared_coalesced_noconst, byte_array_ref)
...
def test6_RoundTest():
    ...
    # Reference output
    byte_array_ref = np.array(
        [0x72, 0x7C, 0x87, 0xAD, 0xBD, 0x1E, 0x1D, 0x46, 0xA5, 0x08, 0x7C, 0x8B, 0x1B, 0x90, 0xB8, 0x30,
...
def test7_RoundTest():
    ...
    # Reference output
    byte_array_ref = np.array(
        [0xBF, 0x83, 0xD4, 0xDB, 0xB1, 0xCF, 0xED, 0x30, 0xB1, 0x88, 0xE9, 0xEB, 0x19, 0xF8, 0x6E, 0xB5,
...
def test8_speedtest():
    ...
    for test_size in tqdm(test_sizes):
        ...
        byte_array_ref = "203040"

        graphicscomputer = AESTest()

        # Medir el tiempo de ejecución de cada variante
        start_time = time.time()
        result_gpu_naive = graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 16, "naive")[0]
        end_time = time.time()
        time_gpu_naive = end_time - start_time
        # assert np.array_equal(result_gpu_naive, byte_array_ref)
        print(f"Tiempo de ejecución para 'naive': {time_gpu_naive:.4f} segundos")

        start_time = time.time()
        result_gpu_shared = graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 16, "shared")[0]
        end_time = time.time()
        time_gpu_shared = end_time - start_time
        # assert np.array_equal(result_gpu_shared, byte_array_ref)
        print(f"Tiempo de ejecución para 'shared': {time_gpu_shared:.4f} segundos")

        start_time = time.time()
        result_gpu_shared_coalesced = graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 16, "shared_coalesced")[0]
        end_time = time.time()
        time_gpu_shared_coalesced = end_time - start_time
        # assert np.array_equal(result_gpu_shared_coalesced, byte_array_ref)
        print(f"Tiempo de ejecución para 'shared_coalesced': {time_gpu_shared_coalesced:.4f} segundos")

        start_time = time.time()
        result_gpu_shared_coalesced_noconst = \
            graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 16, "shared_coalesced_noconst")[0]
        end_time = time.time()
        time_gpu_shared_coalesced_noconst = end_time - start_time
        # assert np.array_equal(result_gpu_shared_coalesced_noconst, byte_array_ref)
        print(f"Tiempo de ejecución para 'shared_coalesced_noconst': {time_gpu_shared_coalesced_noconst:.4f} segundos")

        start_time = time.time()
        result_gpu_private = graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 16, "private")[0]
        end_time = time.time()
        time_gpu_private = end_time - start_time
        # assert np.array_equal(result_gpu_private, byte_array_ref)
        print(f"Tiempo de ejecución para 'private': {time_gpu_private:.4f} segundos")

        start_time = time.time()
        result_gpu_private_sharedlut = graphicscomputer.AES_gpu(byte_array_in, byte_array_key, 16, "private_sharedlut")[0]
        end_time = time.time()
        time_gpu_private_sharedlut = end_time - start_time
        # assert np.array_equal(result_gpu_private_sharedlut, byte_array_ref)
        print(f"Tiempo de ejecución para 'private_sharedlut': {time_gpu_private_sharedlut:.4f} segundos")
    ...
    for test_size in tqdm(test_sizes):
        ...
        for iteration in range(nr_iterations):
            ...
            time_gpu_shared_coalesced = \
                graphicscomputer.AES_gpu(byte_array_in, byte_array_key, byte_array_in.size, "shared_coalesced")[1]
            ...
            time_private_sharedlut = \
                graphicscomputer.AES_gpu(byte_array_in, byte_array_key, byte_array_in.size, "private_sharedlut")[1]
